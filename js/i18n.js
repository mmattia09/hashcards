...
(function (global) {
  ...
  DICTS.en = {
    ...
    'home.startDue': 'Review {n} due cards',
    'home.startDueOne': 'Review 1 due card',
    ...
    'settings.exportHelp':
      'Downloads your hashes, salts and progress — no passwords. Encrypt it with a passphrase, or keep the plain file as private as you would anything password-adjacent: a hash can be attacked offline.',
    'settings.import': 'Import deck',
    'settings.importHelp': 'Load a file exported by Hashcards, on this device or another. Encrypted files ask for their passphrase.',
    ...
    'dialog.export.title': 'Export deck',
    'dialog.export.plain': 'Plain JSON',
    'dialog.export.plainHelp': 'Anything can read it: account names, hints and hashes all in the open.',
    'dialog.export.encrypted': 'Encrypted with a passphrase',
    'dialog.export.encryptedHelp': 'AES-GCM, with the key derived from your passphrase. Nothing in the file is readable without it.',
    'dialog.export.passphrase': 'Passphrase',
    'dialog.export.passphraseRepeat': 'Repeat passphrase',
    'dialog.export.warning': 'There is no way back: lose this passphrase and the file is unreadable, by you as well.',
    'dialog.export.confirm': 'Export',
    'dialog.export.encrypting': 'Encrypting…',
    ...
    'dialog.import.passphrase': 'Passphrase',
    'dialog.import.passphraseHelp': 'This file is encrypted. Type the passphrase it was exported with.',
    'dialog.import.decrypting': 'Decrypting…',
    ...
    'error.passphraseRequired': 'Choose a passphrase for the file.',
    'error.passphraseMismatch': 'The two passphrases do not match.',
    'error.passphraseNeeded': 'This file is encrypted. Type its passphrase.',
    'error.wrongPassphrase': 'Wrong passphrase, or the file has been altered.',
    'error.encryptFailed': 'The file could not be encrypted.',
    ...
    'toast.exportedEncrypted': 'Encrypted deck exported',
  ...
  DICTS.it = {
    ...
    'home.startDue': 'Ripassa {n} carte in scadenza',
    'home.startDueOne': 'Ripassa 1 carta in scadenza',
    ...
    'settings.exportHelp':
      'Scarica hash, sali e progressi: nessuna password. Puoi cifrarlo con una passphrase, altrimenti tieni il file in chiaro con la stessa cura di qualsiasi cosa vicina a una password: un hash si può attaccare offline.',
    'settings.import': 'Importa un mazzo',
    'settings.importHelp': 'Carica un file esportato da Hashcards, da questo o da un altro dispositivo. Se è cifrato, ti verrà chiesta la passphrase.',
    ...
    'dialog.export.title': 'Esporta il mazzo',
    'dialog.export.plain': 'JSON in chiaro',
    'dialog.export.plainHelp': 'Leggibile da chiunque: nomi degli account, indizi e hash tutti allo scoperto.',
    'dialog.export.encrypted': 'Cifrato con una passphrase',
    'dialog.export.encryptedHelp': 'AES-GCM, con la chiave derivata dalla tua passphrase. Senza, nel file non si legge niente.',
    'dialog.export.passphrase': 'Passphrase',
    'dialog.export.passphraseRepeat': 'Ripeti la passphrase',
    'dialog.export.warning': 'Non si torna indietro: se perdi questa passphrase il file diventa illeggibile, anche per te.',
    'dialog.export.confirm': 'Esporta',
    'dialog.export.encrypting': 'Cifro…',
    ...
    'dialog.import.passphrase': 'Passphrase',
    'dialog.import.passphraseHelp': 'Questo file è cifrato. Scrivi la passphrase con cui è stato esportato.',
    'dialog.import.decrypting': 'Decifro…',
    ...
    'error.passphraseRequired': 'Scegli una passphrase per il file.',
    'error.passphraseMismatch': 'Le due passphrase non coincidono.',
    'error.passphraseNeeded': 'Questo file è cifrato. Scrivi la sua passphrase.',
    'error.wrongPassphrase': 'Passphrase sbagliata, oppure il file è stato manomesso.',
    'error.encryptFailed': 'Non è stato possibile cifrare il file.',
    ...
    'toast.exportedEncrypted': 'Mazzo cifrato esportato',
  ...
  DICTS.es = {
    ...
    'home.startDue': 'Repasar {n} tarjetas pendientes',
    'home.startDueOne': 'Repasar 1 tarjeta pendiente',
    ...
    'settings.exportHelp':
      'Descarga los hashes, las sales y tu progreso: ninguna contraseña. Puedes cifrarlo con una frase de paso; en claro, guárdalo con el mismo cuidado que cualquier cosa cercana a una contraseña, porque un hash se puede atacar sin conexión.',
    'settings.import': 'Importar un mazo',
    'settings.importHelp': 'Carga un archivo exportado por Hashcards, desde este u otro dispositivo. Si está cifrado, te pedirá la frase de paso.',
    ...
    'dialog.export.title': 'Exportar el mazo',
    'dialog.export.plain': 'JSON en claro',
    'dialog.export.plainHelp': 'Legible por cualquiera: nombres de cuenta, pistas y hashes al descubierto.',
    'dialog.export.encrypted': 'Cifrado con una frase de paso',
    'dialog.export.encryptedHelp': 'AES-GCM, con la clave derivada de tu frase de paso. Sin ella no se lee nada del archivo.',
    'dialog.export.passphrase': 'Frase de paso',
    'dialog.export.passphraseRepeat': 'Repite la frase de paso',
    'dialog.export.warning': 'No hay vuelta atrás: si pierdes esta frase de paso el archivo queda ilegible, también para ti.',
    'dialog.export.confirm': 'Exportar',
    'dialog.export.encrypting': 'Cifrando…',
    ...
    'dialog.import.passphrase': 'Frase de paso',
    'dialog.import.passphraseHelp': 'Este archivo está cifrado. Escribe la frase de paso con la que se exportó.',
    'dialog.import.decrypting': 'Descifrando…',
    ...
    'error.passphraseRequired': 'Elige una frase de paso para el archivo.',
    'error.passphraseMismatch': 'Las dos frases de paso no coinciden.',
    'error.passphraseNeeded': 'Este archivo está cifrado. Escribe su frase de paso.',
    'error.wrongPassphrase': 'Frase de paso incorrecta, o el archivo ha sido alterado.',
    'error.encryptFailed': 'No se ha podido cifrar el archivo.',
    ...
    'toast.exportedEncrypted': 'Mazo cifrado exportado',
  ...
  DICTS.de = {
    ...
    'home.startDue': '{n} fällige Karten wiederholen',
    'home.startDueOne': '1 fällige Karte wiederholen',
    ...
    'settings.exportHelp':
      'Lädt Hashes, Salts und Fortschritt herunter — keine Passwörter. Du kannst die Datei mit einer Passphrase verschlüsseln; unverschlüsselt behandle sie so sorgsam wie alles Passwortnahe: Ein Hash lässt sich offline angreifen.',
    'settings.import': 'Stapel importieren',
    'settings.importHelp': 'Lade eine von Hashcards exportierte Datei, von diesem oder einem anderen Gerät. Verschlüsselte Dateien fragen nach ihrer Passphrase.',
    ...
    'dialog.export.title': 'Stapel exportieren',
    'dialog.export.plain': 'Unverschlüsseltes JSON',
    'dialog.export.plainHelp': 'Für jeden lesbar: Kontonamen, Hinweise und Hashes liegen offen.',
    'dialog.export.encrypted': 'Mit einer Passphrase verschlüsselt',
    'dialog.export.encryptedHelp': 'AES-GCM, mit einem aus deiner Passphrase abgeleiteten Schlüssel. Ohne sie ist in der Datei nichts lesbar.',
    'dialog.export.passphrase': 'Passphrase',
    'dialog.export.passphraseRepeat': 'Passphrase wiederholen',
    'dialog.export.warning': 'Es gibt keinen Weg zurück: Ist die Passphrase weg, ist die Datei unlesbar — auch für dich.',
    'dialog.export.confirm': 'Exportieren',
    'dialog.export.encrypting': 'Wird verschlüsselt…',
    ...
    'dialog.import.passphrase': 'Passphrase',
    'dialog.import.passphraseHelp': 'Diese Datei ist verschlüsselt. Tipp die Passphrase ein, mit der sie exportiert wurde.',
    'dialog.import.decrypting': 'Wird entschlüsselt…',
    ...
    'error.passphraseRequired': 'Wähl eine Passphrase für die Datei.',
    'error.passphraseMismatch': 'Die beiden Passphrasen stimmen nicht überein.',
    'error.passphraseNeeded': 'Diese Datei ist verschlüsselt. Tipp ihre Passphrase ein.',
    'error.wrongPassphrase': 'Falsche Passphrase, oder die Datei wurde verändert.',
    'error.encryptFailed': 'Die Datei konnte nicht verschlüsselt werden.',
    ...
    'toast.exportedEncrypted': 'Verschlüsselter Stapel exportiert',
  ...
  DICTS.fr = {
    ...
    'home.startDue': 'Réviser {n} cartes en attente',
    'home.startDueOne': 'Réviser 1 carte en attente',
    ...
    'settings.exportHelp':
      'Télécharge les empreintes, les sels et ta progression — aucun mot de passe. Tu peux le chiffrer avec une phrase secrète ; en clair, garde-le aussi précieusement que tout ce qui touche à un mot de passe : une empreinte s’attaque hors ligne.',
    'settings.import': 'Importer un paquet',
    'settings.importHelp': 'Charge un fichier exporté par Hashcards, depuis cet appareil ou un autre. Les fichiers chiffrés demandent leur phrase secrète.',
    ...
    'dialog.export.title': 'Exporter le paquet',
    'dialog.export.plain': 'JSON en clair',
    'dialog.export.plainHelp': 'Lisible par n’importe qui : noms de comptes, indices et empreintes à découvert.',
    'dialog.export.encrypted': 'Chiffré avec une phrase secrète',
    'dialog.export.encryptedHelp': 'AES-GCM, avec la clé dérivée de ta phrase secrète. Sans elle, rien n’est lisible dans le fichier.',
    'dialog.export.passphrase': 'Phrase secrète',
    'dialog.export.passphraseRepeat': 'Répète la phrase secrète',
    'dialog.export.warning': 'Aucun retour en arrière : phrase secrète perdue, fichier illisible — pour toi aussi.',
    'dialog.export.confirm': 'Exporter',
    'dialog.export.encrypting': 'Chiffrement…',
    ...
    'dialog.import.passphrase': 'Phrase secrète',
    'dialog.import.passphraseHelp': 'Ce fichier est chiffré. Saisis la phrase secrète utilisée à l’export.',
    'dialog.import.decrypting': 'Déchiffrement…',
    ...
    'error.passphraseRequired': 'Choisis une phrase secrète pour le fichier.',
    'error.passphraseMismatch': 'Les deux phrases secrètes ne correspondent pas.',
    'error.passphraseNeeded': 'Ce fichier est chiffré. Saisis sa phrase secrète.',
    'error.wrongPassphrase': 'Phrase secrète incorrecte, ou fichier altéré.',
    'error.encryptFailed': 'Le fichier n’a pas pu être chiffré.',
    ...
    'toast.exportedEncrypted': 'Paquet chiffré exporté',
