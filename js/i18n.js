...
(function (global) {
  ...
  DICTS.en = {
    ...
    'card.codes': '{n} recovery codes',
    'card.codesOne': '1 recovery code',
    'card.review': 'Review this card',
    'card.edit': 'Edit',
    'card.delete': 'Delete',

    'study.questionCodes': 'Recovery codes for',
    'study.codeOf': 'Code {i} of {n}',
    'study.codePlaceholder': 'Any code not yet given',
    'study.codeCorrect': 'That is one of them',
    'study.codeWrong': 'Not one of the codes still outstanding',
    'study.codeWrongHelp': 'Order does not matter — any code you have not already given counts.',
    ...
    'dialog.type': 'This card holds',
    'dialog.typePassword': 'A password',
    'dialog.typeCodes': 'Recovery codes',
    'dialog.codes': 'Recovery codes',
    'dialog.codesPlaceholder': 'One code per line',
    'dialog.codesHelp': 'One per line, up to {max}. Spaces, dashes and capitals are ignored when you answer, so paste them exactly as the service gave them.',
    'dialog.codesCounted': '{n} codes',
    'dialog.codesCountedOne': '1 code',
    'dialog.keepCodes': 'Keep the current codes',
    'dialog.changeCodes': 'Replace the codes',
    'dialog.hashingCodes': 'Hashing {i} of {n}…',
    ...
    'error.codesRequired': 'Type at least one recovery code.',
    'error.tooManyCodes': 'That is more than {max} codes.',
  ...
  DICTS.it = {
    ...
    'card.codes': '{n} codici di recupero',
    'card.codesOne': '1 codice di recupero',
    'card.review': 'Ripassa questa carta',
    'card.edit': 'Modifica',
    'card.delete': 'Elimina',

    'study.questionCodes': 'Codici di recupero di',
    'study.codeOf': 'Codice {i} di {n}',
    'study.codePlaceholder': 'Un codice non ancora dato',
    'study.codeCorrect': 'È uno di quelli',
    'study.codeWrong': 'Non è tra i codici che restano',
    'study.codeWrongHelp': 'L’ordine non conta: vale qualsiasi codice che non hai già dato.',
    ...
    'dialog.type': 'Su questa carta c’è',
    'dialog.typePassword': 'Una password',
    'dialog.typeCodes': 'Codici di recupero',
    'dialog.codes': 'Codici di recupero',
    'dialog.codesPlaceholder': 'Un codice per riga',
    'dialog.codesHelp': 'Uno per riga, fino a {max}. Quando rispondi, spazi, trattini e maiuscole non contano: incollali pure come te li ha dati il servizio.',
    'dialog.codesCounted': '{n} codici',
    'dialog.codesCountedOne': '1 codice',
    'dialog.keepCodes': 'Mantieni i codici attuali',
    'dialog.changeCodes': 'Sostituisci i codici',
    'dialog.hashingCodes': 'Calcolo l’hash {i} di {n}…',
    'dialog.password': 'Password',
    ...
    'error.codesRequired': 'Scrivi almeno un codice di recupero.',
    'error.tooManyCodes': 'Sono più di {max} codici.',
  ...
  DICTS.es = {
    ...
    'card.codes': '{n} códigos de recuperación',
    'card.codesOne': '1 código de recuperación',
    'card.review': 'Repasar esta tarjeta',
    'card.edit': 'Editar',
    'card.delete': 'Eliminar',

    'study.questionCodes': 'Códigos de recuperación de',
    'study.codeOf': 'Código {i} de {n}',
    'study.codePlaceholder': 'Un código no dado aún',
    'study.codeCorrect': 'Es uno de ellos',
    'study.codeWrong': 'No está entre los códigos que quedan',
    'study.codeWrongHelp': 'El orden no importa: vale cualquier código que no hayas dado ya.',
    ...
    'dialog.type': 'En esta tarjeta hay',
    'dialog.typePassword': 'Una contraseña',
    'dialog.typeCodes': 'Códigos de recuperación',
    'dialog.codes': 'Códigos de recuperación',
    'dialog.codesPlaceholder': 'Un código por línea',
    'dialog.codesHelp': 'Uno por línea, hasta {max}. Al responder no cuentan espacios, guiones ni mayúsculas: pégalos tal como te los dio el servicio.',
    'dialog.codesCounted': '{n} códigos',
    'dialog.codesCountedOne': '1 código',
    'dialog.keepCodes': 'Mantener los códigos actuales',
    'dialog.changeCodes': 'Sustituir los códigos',
    'dialog.hashingCodes': 'Calculando {i} de {n}…',
    ...
    'error.codesRequired': 'Escribe al menos un código de recuperación.',
    'error.tooManyCodes': 'Son más de {max} códigos.',
  ...
  DICTS.de = {
    ...
    'card.codes': '{n} Wiederherstellungscodes',
    'card.codesOne': '1 Wiederherstellungscode',
    'card.review': 'Diese Karte wiederholen',
    'card.edit': 'Bearbeiten',
    'card.delete': 'Löschen',

    'study.questionCodes': 'Wiederherstellungscodes für',
    'study.codeOf': 'Code {i} von {n}',
    'study.codePlaceholder': 'Ein noch offener Code',
    'study.codeCorrect': 'Das ist einer davon',
    'study.codeWrong': 'Keiner der noch offenen Codes',
    'study.codeWrongHelp': 'Die Reihenfolge ist egal — es zählt jeder Code, den du noch nicht genannt hast.',
    ...
    'dialog.type': 'Auf dieser Karte steht',
    'dialog.typePassword': 'Ein Passwort',
    'dialog.typeCodes': 'Wiederherstellungscodes',
    'dialog.codes': 'Wiederherstellungscodes',
    'dialog.codesPlaceholder': 'Ein Code pro Zeile',
    'dialog.codesHelp': 'Einer pro Zeile, bis zu {max}. Beim Antworten zählen Leerzeichen, Bindestriche und Großschreibung nicht — füg sie ruhig genau so ein, wie der Dienst sie ausgegeben hat.',
    'dialog.codesCounted': '{n} Codes',
    'dialog.codesCountedOne': '1 Code',
    'dialog.keepCodes': 'Aktuelle Codes behalten',
    'dialog.changeCodes': 'Codes ersetzen',
    'dialog.hashingCodes': 'Hashe {i} von {n}…',
    ...
    'error.codesRequired': 'Tipp mindestens einen Wiederherstellungscode ein.',
    'error.tooManyCodes': 'Das sind mehr als {max} Codes.',
  ...
  DICTS.fr = {
    ...
    'card.codes': '{n} codes de récupération',
    'card.codesOne': '1 code de récupération',
    'card.review': 'Réviser cette carte',
    'card.edit': 'Modifier',
    'card.delete': 'Supprimer',

    'study.questionCodes': 'Codes de récupération de',
    'study.codeOf': 'Code {i} sur {n}',
    'study.codePlaceholder': 'Un code pas encore donné',
    'study.codeCorrect': 'C’en est un',
    'study.codeWrong': 'Pas un des codes restants',
    'study.codeWrongHelp': 'L’ordre n’a pas d’importance : tout code pas encore donné compte.',
    ...
    'dialog.type': 'Cette carte contient',
    'dialog.typePassword': 'Un mot de passe',
    'dialog.typeCodes': 'Des codes de récupération',
    'dialog.codes': 'Codes de récupération',
    'dialog.codesPlaceholder': 'Un code par ligne',
    'dialog.codesHelp': 'Un par ligne, jusqu’à {max}. À la réponse, espaces, tirets et majuscules ne comptent pas : colle-les tels que le service te les a donnés.',
    'dialog.codesCounted': '{n} codes',
    'dialog.codesCountedOne': '1 code',
    'dialog.keepCodes': 'Garder les codes actuels',
    'dialog.changeCodes': 'Remplacer les codes',
    'dialog.hashingCodes': 'Hachage {i} sur {n}…',
    ...
    'error.codesRequired': 'Saisis au moins un code de récupération.',
    'error.tooManyCodes': 'Cela fait plus de {max} codes.',
